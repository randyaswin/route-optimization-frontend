...
import { Pagination, UploadHubs } from '@app/api/hub.api';
...
export const UploadForm: React.FC<any> = ({ isUploadModalVisible, setIsUploadModalVisible }) => {
  ...
  const onFinish = async (values = {}) => {
    ...
    setLoading(true);
    await UploadHubs(fileList.fileList[0].originFileObj)
      .then((res) => {
    ...
    dispatch(getHub({ pagination: initialPagination, sorter: {} }));
  };
